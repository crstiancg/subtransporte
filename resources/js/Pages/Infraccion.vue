  ...
  <nav class="bg-gray-800 border-gray-200 dark:bg-gray-900">
    ...
    >
      <a href="/" class="flex items-center">
        ...
        />
        <span
          class="text-white self-center text-xl font-semibold whitespace-nowrap dark:text-white"
          >Transportes</span
        >
      </a>
...
<footer
    class="w-full bg-gray-800 shadow dark:bg-gray-800 fixed left-0 bottom-0 flex justify-center items-center"
  >
    <div
      class="w-fullrounded-full p-4 justify-center"
    >
      <span class="text-lg text-gray-100 sm:text-center dark:text-gray-400"
        >© 2023 <a href="#" class="hover:underline">Gerencia de Transporte™</a> -
